        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                    CommentsModel modelComment = dataSnapshot1.getValue(CommentsModel.class);
                    commentList.add(modelComment);
                    adapterComment = new CommentsAdapter(getApplicationContext(), commentList, myuid, postId);
    ...
    private void loadPostInfo() {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                    String ptitle = Objects.requireNonNull(dataSnapshot1.child("title").getValue()).toString();
                    ...
                    String uemail = Objects.requireNonNull(dataSnapshot1.child("uemail").getValue()).toString();
